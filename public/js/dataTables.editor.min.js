...
$jscomp.findInternal = function (e, y, z) {
  ...
  for (var u = e.length, C = 0; C < u; C++) {
    var I = e[C];
    if (y.call(z, I, C, e)) return { i: C, v: I };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
var $jscomp$lookupPolyfilledValue = function (e, y) {
...
$jscomp.polyfill = function (e, y, z, u) {
  y &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(e, y, z, u)
      : $jscomp.polyfillUnisolated(e, y, z, u));
};
$jscomp.polyfillUnisolated = function (e, y, z, u) {
  ...
  y != u &&
    null != y &&
    $jscomp.defineProperty(z, e, { configurable: !0, writable: !0, value: y });
};
...
(function (e) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (y, z) {
        y || (y = window);
        (z && z.fn.dataTable) || (z = require("datatables.net")(y, z).$);
        return e(z, y, y.document);
      })
  ...
  function I(a, b, d, f) {
    ...
    b.message === u &&
      ("remove" === d
        ? ((a = a.i18n[d].confirm),
          (b.message = 1 !== f ? a._.replace(/%d/, f) : a["1"]))
        : (b.message = ""));
    return b;
  }
  var E = e.fn.dataTable;
  if (!E || !E.versionCheck || !E.versionCheck("1.10.7"))
    throw Error("Editor requires DataTables 1.10.7 or newer");
  var m = function (a) {
    this instanceof m ||
  ...
  m.Field = function (a, b, d) {
    ...
    var c = E.ext.oApi;
    this.valFromData = function (n) {
      return c._fnGetObjectDataFn(a.data)(n, "editor");
    };
    ...
    var h = e(
      '<div class="' +
        ...
        b.inputControl +
        '"></div><div data-dte-e="multi-value" class="' +
        b.multiValue +
        '">' +
        g.title +
        ...
        '">' +
        g.info +
        '</span></div><div data-dte-e="msg-multi" class="' +
        b.multiRestore +
        '">' +
        g.restore +
        '</div><div data-dte-e="msg-error" class="' +
        b["msg-error"] +
        ...
        '">' +
        a.fieldInfo +
        '</div></div><div data-dte-e="field-processing" class="' +
        b.processing +
        '"><span></span></div></div>'
    );
    d = this._typeFn("create", a);
    null !== d ? G("input-control", h).prepend(d) : h.css("display", "none");
    this.dom = e.extend(!0, {}, m.Field.models.dom, {
      container: h,
      inputControl: G("input-control", h),
      label: G("label", h),
      fieldInfo: G("msg-info", h),
      labelInfo: G("msg-label", h),
      fieldError: G("msg-error", h),
      fieldMessage: G("msg-message", h),
      multi: G("multi-value", h),
      multiReturn: G("msg-multi", h),
      multiInfo: G("multi-info", h),
      processing: G("field-processing", h),
    });
    this.dom.multi.on("click", function () {
      f.s.opts.multiEditable &&
        !h.hasClass(b.disabled) &&
        "readonly" !== a.type &&
        (f.val(""), f.focus());
    });
    ...
    e.each(this.s.type, function (n, p) {
      "function" === typeof p &&
        f[n] === u &&
        (f[n] = function () {
  ...
  m.Field.prototype = {
    ...
    input: function () {
      return this.s.type.input
        ? this._typeFn("input")
        : e("input, select, textarea", this.dom.container);
    },
    focus: function () {
      this.s.type.focus
        ? this._typeFn("focus")
        : e("input, select, textarea", this.dom.container).focus();
      return this;
    },
    get: function () {
    ...
    hide: function (a) {
      ...
      a === u && (a = !0);
      this.s.host.display() && a && e.fn.slideUp
        ? b.slideUp()
        : b.css("display", "none");
      return this;
    },
    ...
    multiGet: function (a) {
      ...
      if (a === u) {
        var g = this.val();
        a = {};
        for (var c = 0; c < d.length; c++) a[d[c]] = f ? b[d[c]] : g;
    ...
    multiSet: function (a, b) {
      ...
      e.isPlainObject(b) && a === u
        ? e.each(b, function (c, h) {
            g(c, h);
          })
        : a === u
        ? e.each(f, function (c, h) {
            g(h, b);
          })
        : g(a, b);
      this.s.multiValue = !0;
    ...
    set: function (a, b) {
      ...
      if (f === u || !0 === f)
        if (Array.isArray(a)) {
          f = 0;
          for (var g = a.length; f < g; f++) a[f] = d(a[f]);
        } else a = d(a);
      this._typeFn("set", a);
    ...
    show: function (a) {
      var b = this.dom.container;
      a === u && (a = !0);
      this.s.host.display() && a && e.fn.slideDown
        ? b.slideDown()
        : b.css("display", "");
      return this;
    },
    ...
    multiInfoShown: function (a) {
      this.dom.multiInfo.css({ display: a ? "block" : "none" });
    },
    multiReset: function () {
      this.s.multiIds = [];
      this.s.multiValues = {};
    ...
    _msg: function (a, b, d) {
      ...
      a.parent().is(":visible") && e.fn.animate
        ? (a.html(b), b ? a.slideDown(d) : a.slideUp(d))
        : (a.html(b || "").css("display", b ? "block" : "none"), d && d());
      return this;
    },
    _multiValueCheck: function () {
      ...
      this.dom.multiReturn.css({
        display: a && 1 < a.length && g && !d ? "block" : "none",
      });
      n = this.s.host.i18n.multi;
      this.dom.multiInfo.html(f ? n.info : n.noMulti);
  ...
  m.models.button = { label: null, fn: null, className: null };
  ...
  (function () {
    function a() {
      return "undefined" !== typeof y.orientation && 576 >= y.outerWidth
        ? !0
        : !1;
    }
    m.display.lightbox = e.extend(!0, {}, m.models.displayController, {
      ...
      open: function (d, f, g) {
        b._shown
          ...
          : ((b._dte = d),
            (d = b._dom.content),
            d.children().detach(),
            d.append(f).append(b._dom.close),
            (b._shown = !0),
            b._show(g));
      },
      close: function (d, f) {
        b._shown ? ((b._dte = d), b._hide(f), (b._shown = !1)) : f && f();
      },
      node: function (d) {
        return b._dom.wrapper[0];
      },
      _init: function () {
        if (!b._ready) {
          var d = b._dom;
          d.content = e("div.DTED_Lightbox_Content", b._dom.wrapper);
          d.wrapper.css("opacity", 0);
          d.background.css("opacity", 0);
        }
      },
      _show: function (d) {
        var f = b._dom;
        a() && e("body").addClass("DTED_Lightbox_Mobile");
        f.content.css("height", "auto");
        f.wrapper.css({ top: -b.conf.offsetAni });
        e("body").append(b._dom.background).append(b._dom.wrapper);
        b._heightCalc();
        b._dte._animate(f.wrapper, { opacity: 1, top: 0 }, d);
        b._dte._animate(f.background, { opacity: 1 });
        setTimeout(function () {
          e("div.DTE_Footer").css("text-indent", -1);
        }, 10);
        f.close
          .attr("title", b._dte.i18n.close)
          .on("click.DTED_Lightbox", function (g) {
            b._dte.close();
          });
        f.background.on("click.DTED_Lightbox", function (g) {
          g.stopImmediatePropagation();
          b._dte.background();
        });
        e("div.DTED_Lightbox_Content_Wrapper", f.wrapper).on(
          "click.DTED_Lightbox",
          function (g) {
            e(g.target).hasClass("DTED_Lightbox_Content_Wrapper") &&
              (g.stopImmediatePropagation(), b._dte.background());
          }
        );
        e(y).on("resize.DTED_Lightbox", function () {
          b._heightCalc();
        });
        b._scrollTop = e("body").scrollTop();
      },
      _heightCalc: function () {
        var d = b._dom,
          f =
            e("div.DTE_Header", d.wrapper).outerHeight() +
            e("div.DTE_Footer", d.wrapper).outerHeight();
        a()
          ? e("div.DTE_Body_Content", d.wrapper).css(
              "maxHeight",
              "calc(100vh - " + f + "px)"
            )
          : ((f = e(y).height() - 2 * b.conf.windowPadding - f),
            e("div.DTE_Body_Content", d.wrapper).css("maxHeight", f));
      },
      _hide: function (d) {
        var f = b._dom;
        d || (d = function () {});
        e("body").scrollTop(b._scrollTop);
        b._dte._animate(
          f.wrapper,
          { opacity: 0, top: b.conf.offsetAni },
          function () {
            e(this).detach();
            d();
          }
        );
        b._dte._animate(f.background, { opacity: 0 }, function () {
          e(this).detach();
        });
        f.close.off("click.DTED_Lightbox");
        f.background.off("click.DTED_Lightbox");
        e("div.DTED_Lightbox_Content_Wrapper", f.wrapper).off(
          "click.DTED_Lightbox"
        );
        e(y).off("resize.DTED_Lightbox");
      },
      _dte: null,
      _ready: !1,
      _shown: !1,
      _dom: {
        wrapper: e(
          '<div class="DTED DTED_Lightbox_Wrapper"><div class="DTED_Lightbox_Container"><div class="DTED_Lightbox_Content_Wrapper"><div class="DTED_Lightbox_Content"></div></div></div></div>'
        ),
        background: e(
    ...
    var b = m.display.lightbox;
    b.conf = { offsetAni: 25, windowPadding: 25 };
  })();
  (function () {
    m.display.envelope = e.extend(!0, {}, m.models.displayController, {
      ...
      _init: function () {
        a._ready ||
          ...
          (a._dom.background.style.visbility = "hidden"),
          (a._dom.background.style.display = "block"),
          (a._cssBackgroundOpacity = e(a._dom.background).css("opacity")),
          (a._dom.background.style.display = "none"),
          (a._dom.background.style.visbility = "visible"));
      },
      _show: function (b) {
        b || (b = function () {});
        ...
        a._dom.content.style.top = -1 * g - 20 + "px";
        ...
        a.conf.windowScroll
          ? e("html,body").animate(
              {
                scrollTop:
                  e(f).offset().top + f.offsetHeight - a.conf.windowPadding,
              },
              function () {
                e(a._dom.content).animate({ top: 0 }, 600, b);
              }
            )
          : e(a._dom.content).animate({ top: 0 }, 600, b);
        e(a._dom.close)
          .attr("title", a._dte.i18n.close)
          .on("click.DTED_Envelope", function (h) {
            a._dte.close();
          });
        e(a._dom.background).on("click.DTED_Envelope", function (h) {
          a._dte.background();
        });
        e("div.DTED_Lightbox_Content_Wrapper", a._dom.wrapper).on(
          "click.DTED_Envelope",
          function (h) {
            e(h.target).hasClass("DTED_Envelope_Content_Wrapper") &&
              a._dte.background();
          }
        );
        e(y).on("resize.DTED_Envelope", function () {
          a._heightCalc();
        });
      },
      _heightCalc: function () {
        a.conf.heightCalc
          ? a.conf.heightCalc(a._dom.wrapper)
          : e(a._dom.content).children().height();
        var b =
          e(y).height() -
          2 * a.conf.windowPadding -
          e("div.DTE_Header", a._dom.wrapper).outerHeight() -
          e("div.DTE_Footer", a._dom.wrapper).outerHeight();
      ...
      _hide: function (b) {
        ...
        e(a._dom.content).animate(
          ...
          600,
          function () {
            e([a._dom.wrapper, a._dom.background]).fadeOut(
              "normal",
              function () {
                e(this).detach();
                b();
        ...
        e(a._dom.close).off("click.DTED_Lightbox");
        e(a._dom.background).off("click.DTED_Lightbox");
        e("div.DTED_Lightbox_Content_Wrapper", a._dom.wrapper).off(
          "click.DTED_Lightbox"
        );
        e(y).off("resize.DTED_Lightbox");
      },
      _findAttachRow: function () {
        ...
        return "head" === a.conf.attach
          ? b.table().header()
          : "create" === a._dte.s.action
          ? b.table().header()
          : b.row(a._dte.s.modifier).node();
      },
      _dte: null,
      _ready: !1,
      ...
      _dom: {
        wrapper: e(
          '<div class="DTED DTED_Envelope_Wrapper"><div class="DTED_Envelope_Shadow"></div><div class="DTED_Envelope_Container"></div></div>'
        )[0],
        background: e(
  ...
  m.prototype.add = function (a, b, d) {
    if (Array.isArray(a)) {
      b !== u && a.reverse();
      for (d = 0; d < a.length; d++) this.add(a[d], b, !1);
      this._displayReorder(this.order());
      return this;
    }
    var f = a.name;
    if (f === u) throw "Error adding field. The field requires a `name` option";
    if (this.s.fields[f])
      throw (
        "Error adding field '" + f + "'. A field already exists with this name"
      );
    this._dataSource("initField", a);
    var g = new m.Field(a, this.classes.field, this);
    this.s.mode &&
      ((a = this.s.editFields),
      g.multiReset(),
      e.each(a, function (c, h) {
        var n;
        h.data && (n = g.valFromData(h.data));
        g.multiSet(c, n !== u ? n : g.def());
      }));
    this.s.fields[f] = g;
    b === u
      ? this.s.order.push(f)
      : null === b
      ? this.s.order.unshift(f)
      : ((b = e.inArray(b, this.s.order)), this.s.order.splice(b + 1, 0, f));
    !1 !== d && this._displayReorder(this.order());
    return this;
  };
  ...
  m.prototype.bubble = function (a, b, d, f) {
    ...
    this._edit(a, c, "bubble", f, function () {
      var h = g._formOptions(f);
      if (!g._preopen("bubble")) return g;
      e(y).on("resize." + h, function () {
        g.bubblePosition();
      });
      var n = [];
      g.s.bubbleNodes = n.concat.apply(n, M(c, "attach"));
      var p = g.classes.bubble;
      n = e('<div class="' + p.bg + '"><div></div></div>');
      var r = e(
        '<div class="' +
          p.wrapper +
          '"><div class="' +
          ...
          '" title="' +
          g.i18n.close +
          '"></div><div class="DTE_Processing_Indicator"><span></div></div></div><div class="' +
          p.pointer +
          '"></div></div>'
      );
      d && (r.appendTo("body"), n.appendTo("body"));
      p = r.children().eq(0);
      var q = p.children(),
        k = q.children();
      p.append(g.dom.formError);
      q.prepend(g.dom.form);
      f.message && p.prepend(g.dom.formInfo);
      f.title && p.prepend(g.dom.header);
      f.buttons && q.append(g.dom.buttons);
      var l = e().add(r).add(n);
      g._closeReg(function (t) {
        g._animate(l, { opacity: 0 }, function () {
          this === r[0] &&
            (l.detach(),
            e(y).off("resize." + h),
            g._clearDynamicInfo(),
            g._event("closed", ["bubble"]));
        });
      });
      n.click(function () {
        g.blur();
      ...
      g.bubblePosition();
      g._animate(l, { opacity: 1 });
      g._focus(g.s.includeFields, f.focus);
      g._postopen("bubble", !0);
    });
    return this;
  };
  m.prototype.bubblePosition = function () {
    ...
    var q = e(y).width();
    a.css({ top: d, left: n });
    b.length && 0 > b.offset().top
      ? a.css("top", h).addClass("below")
      : a.removeClass("below");
    p + 15 > q
      ? b.css("left", 15 > r ? -(r - 15) : -(p - q + 15))
      : b.css("left", 15 > r ? -(r - 15) : 0);
    return this;
  };
  m.prototype.buttons = function (a) {
    ...
    e.each(a, function (d, f) {
      ...
      e("<button></button>", {
        ...
        .html("function" === typeof d ? d(b) : d || "")
        .attr("tabindex", f.tabIndex !== u ? f.tabIndex : 0)
        .on("keyup", function (c) {
          13 === c.keyCode && g && g.call(b);
        })
  ...
  m.prototype.clear = function (a) {
    ...
    "string" === typeof a
      ? (b.field(a).destroy(),
        delete d[a],
        (d = e.inArray(a, this.s.order)),
        this.s.order.splice(d, 1),
        (a = e.inArray(a, this.s.includeFields)),
        -1 !== a && this.s.includeFields.splice(a, 1))
      : e.each(this._fieldNames(a), function (f, g) {
          b.clear(g);
        });
    return this;
  };
  ...
  m.prototype.create = function (a, b, d, f) {
    ...
    if (
      ...
      return this;
    "number" === typeof a && ((h = a), (a = b), (b = d));
    this.s.editFields = {};
    for (var n = 0; n < h; n++)
      this.s.editFields[n] = { fields: this.s.fields };
    var p = this._crudArgs(a, b, d, f);
    this.s.mode = "main";
    ...
    e.each(c, function (r, q) {
      q.multiReset();
      for (r = 0; r < h; r++) q.multiSet(r, q.def());
      q.set(q.def());
    });
    this._event("initCreate", null, function () {
      g._assembleMain();
      g._formOptions(p.opts);
      p.maybeOpen();
    });
    return this;
  };
  m.prototype.undependent = function (a) {
    if (Array.isArray(a)) {
      for (var b = 0, d = a.length; b < d; b++) this.undependent(a[b]);
      return this;
    }
    a = this.field(a);
    e(a.node()).off(".edep");
  ...
  m.prototype.dependent = function (a, b, d) {
    if (Array.isArray(a)) {
      for (var f = 0, g = a.length; f < g; f++) this.dependent(a[f], b, d);
      return this;
    }
    var c = this,
      h = this.field(a),
      n = { type: "POST", dataType: "json" };
    d = e.extend(
      { event: "change", data: null, preUpdate: null, postUpdate: null },
      d
    );
    var p = function (r) {
    ...
    e(h.node()).on(d.event + ".edep", function (r) {
      if (0 !== e(h.node()).find(r.target).length) {
        h.processing(!0);
        r = {};
        ...
        "function" === typeof b
          ? (r = b.call(c, h.val(), r, p)) &&
            ("object" === typeof r && "function" === typeof r.then
              ? r.then(function (k) {
                  k && p(k);
                })
              : p(r))
          : (e.isPlainObject(b) ? e.extend(n, b) : (n.url = b),
            e.ajax(e.extend(n, { url: b, data: r, success: p })));
      }
    });
    return this;
  };
  ...
  m.prototype.edit = function (a, b, d, f, g) {
    var c = this;
    if (
      this._tidy(function () {
        c.edit(a, b, d, f, g);
      ...
      return this;
    var h = this._crudArgs(b, d, f, g);
    this._edit(a, this._dataSource("fields", a), "main", h.opts, function () {
      c._assembleMain();
      c._formOptions(h.opts);
      h.maybeOpen();
    });
    return this;
  };
  ...
  m.prototype.error = function (a, b) {
    ...
    b === u
      ? (this._message(this.dom.formError, a, !0, function () {
          d.toggleClass("inFormError", a !== u && "" !== a);
        }),
        (this.s.globalError = a))
      : this.field(a).error(b);
    return this;
  };
  ...
  m.prototype.inline = function (a, b, d) {
    ...
    var g = this._dataSource("individual", a, b),
      c,
      h,
      n = 0,
      p,
    ...
    e.each(g, function (k, l) {
      if (0 < n) throw "Cannot edit more than one row inline at a time";
      c = e(l.attach[0]);
      p = 0;
      e.each(l.displayFields, function (t, v) {
        if (0 < p) throw "Cannot edit more than one field inline at a time";
        h = v;
        p++;
      });
      n++;
    ...
    if (
      e("div.DTE_Field", c).length ||
      this._tidy(function () {
        f.inline(a, b, d);
      })
    )
      return this;
    this._edit(a, g, "inline", d, function () {
      ...
      c.append(
        e(
          '<div class="' +
            ...
            '" ' +
            t +
            '><div class="DTE_Processing_Indicator"><span></span></div></div><div class="' +
            q.buttons +
            '"></div></div>'
        )
      );
      c.find("div." + q.liner.replace(/ /g, "."))
        .append(h.node())
        .append(f.dom.formError);
      d.buttons &&
        c.find("div." + q.buttons.replace(/ /g, ".")).append(f.dom.buttons);
      ...
      setTimeout(function () {
        if (!r)
          e(z).on("click" + k, function (v) {
            var w = e.fn.addBack ? "addBack" : "andSelf";
            h._typeFn("owns", v.target) ||
              -1 !== e.inArray(c[0], e(v.target).parents()[w]()) ||
              f.blur();
          });
      }, 0);
      f._focus([h], d.focus);
  ...
  m.prototype.mode = function (a) {
    ...
    if ("create" === this.s.action && "create" !== a)
      throw Error("Changing from create mode is not supported");
    this.s.action = a;
    return this;
  };
  ...
  m.prototype.multiSet = function (a, b) {
    var d = this;
    e.isPlainObject(a) && b === u
      ? e.each(a, function (f, g) {
          d.field(f).multiSet(g);
        })
  ...
  m.prototype.remove = function (a, b, d, f, g) {
    var c = this;
    if (
      this._tidy(function () {
        c.remove(a, b, d, f, g);
    ...
    a.length === u && (a = [a]);
    var h = this._crudArgs(b, d, f, g),
      n = this._dataSource("fields", a);
    this.s.action = "remove";
    this.s.modifier = a;
    this.s.editFields = n;
    this.dom.form.style.display = "none";
    this._actionClass();
    this._event("initRemove", [M(n, "node"), M(n, "data"), a], function () {
      c._event("initMultiRemove", [n, a], function () {
        c._assembleMain();
        c._formOptions(h.opts);
        h.maybeOpen();
        var p = c.s.editOpts;
        null !== p.focus && e("button", c.dom.buttons).eq(p.focus).focus();
      });
    });
    return this;
  };
  ...
  m.prototype.submit = function (a, b, d, f) {
    ...
    var r = function () {
      h.length !== n ||
        p ||
        g._event("initSubmit", [g.s.action], function (q) {
          !1 === q ? g._processing(!1) : ((p = !0), g._submit(a, b, d, f));
        });
    };
    this.error();
  ...
  K("row.create()", function (a) {
    var b = C(this);
    b.create(I(b, a, "create"));
    return this;
  });
  K("row().edit()", function (a) {
    var b = C(this);
    b.edit(this[0][0], I(b, a, "edit"));
    return this;
  });
  K("rows().edit()", function (a) {
    var b = C(this);
    b.edit(this[0], I(b, a, "edit"));
    return this;
  });
  K("row().delete()", function (a) {
    var b = C(this);
    b.remove(this[0][0], I(b, a, "remove", 1));
    return this;
  });
  K("rows().delete()", function (a) {
    var b = C(this);
    b.remove(this[0], I(b, a, "remove", this[0].length));
    return this;
  });
  ...
  e(z).on("xhr.dt", function (a, b, d) {
    "dt" === a.namespace &&
      d &&
      d.files &&
      e.each(d.files, function (f, g) {
        m.files[f] || (m.files[f] = {});
        e.extend(m.files[f], g);
      });
  });
  ...
  m.pairs = function (a, b, d) {
    var f;
    b = e.extend({ label: "label", value: "value" }, b);
    if (Array.isArray(a)) {
      var g = 0;
      for (f = a.length; g < f; g++) {
        var c = a[g];
        e.isPlainObject(c)
          ? d(c[b.value] === u ? c[b.label] : c[b.value], c[b.label], g, c.attr)
          : d(c, c, g);
      }
    } else
      (g = 0),
        e.each(a, function (h, n) {
          d(n, h, g);
          g++;
        });
  };
  ...
  m.upload = function (a, b, d, f, g) {
    var c = new FileReader(),
      h = 0,
      n = [];
    a.error(b.name, "");
    "function" === typeof b.ajax
      ? b.ajax(d, function (p) {
          g.call(a, p);
        })
      : (f(b, b.fileReadText || "<i>Uploading file</i>"),
        (c.onload = function (p) {
          ...
          r.append("upload", d[h]);
          b.ajaxData && b.ajaxData(r, d[h], h);
          if (b.ajax) var q = b.ajax;
          else
            e.isPlainObject(a.s.ajax)
              ? (q = a.s.ajax.upload ? a.s.ajax.upload : a.s.ajax)
              : "string" === typeof a.s.ajax && (q = a.s.ajax);
          if (!q) throw Error("No Ajax option specified for upload plug-in");
          "string" === typeof q && (q = { url: q });
          if ("function" === typeof q.data) {
            p = {};
            var k = q.data(p);
            k !== u && "string" !== typeof k && (p = k);
            e.each(p, function (t, v) {
              r.append(t, v);
            });
          } else if (e.isPlainObject(q.data))
            throw Error(
              "Upload feature cannot use `ajax.data` with an object. Please use it as a function instead."
            );
          if (!1 === a._event("preUpload", [b.name, d[h], r]))
            h < d.length - 1 ? (h++, c.readAsDataURL(d[h])) : g.call(a, n);
          else {
            var l = !1;
            ...
            e.ajax(
              e.extend({}, q, {
                ...
                xhr: function () {
                  ...
                  t.upload &&
                    ((t.upload.onprogress = function (v) {
                      v.lengthComputable &&
                        ((v = ((v.loaded / v.total) * 100).toFixed(0) + "%"),
                        f(
                          b,
                          1 === d.length ? v : h + ":" + d.length + " " + v
                        ));
                    }),
                ...
                success: function (t) {
                  ...
                  if (t.fieldErrors && t.fieldErrors.length) {
                    ...
                    t.error
                      ? a.error(t.error)
                      : t.upload && t.upload.id
                      ? (t.files &&
                          e.each(t.files, function (A, x) {
                            m.files[A] || (m.files[A] = {});
                            e.extend(m.files[A], x);
                          }),
                        n.push(t.upload.id),
                        h < d.length - 1
                          ? (h++, c.readAsDataURL(d[h]))
                          : (g.call(a, n), l && a.submit()))
                      : a.error(
                          b.name,
        ...
        (d = e.map(d, function (p) {
          return p;
        })),
        b._limitLeft !== u && d.splice(b._limitLeft, d.length),
        c.readAsDataURL(d[0]));
  };
  m.prototype._constructor = function (a) {
    ...
    this.s = e.extend(!0, {}, m.models.settings, {
      ...
      idSrc: a.idSrc,
      dataSource:
        a.domTable || a.table ? m.dataSources.dataTable : m.dataSources.html,
    ...
    this.dom = {
      wrapper: e(
        '<div class="' +
          ...
          d.processing.indicator +
          '"><span></span></div><div data-dte-e="body" class="' +
          d.body.wrapper +
          '"><div data-dte-e="body_content" class="' +
          d.body.content +
          '"></div></div><div data-dte-e="foot" class="' +
          d.footer.wrapper +
          '"><div class="' +
          d.footer.content +
          '"></div></div></div>'
      ...
      formError: e(
        '<div data-dte-e="form_error" class="' + d.form.error + '"></div>'
      )[0],
      formInfo: e(
        '<div data-dte-e="form_info" class="' + d.form.info + '"></div>'
      )[0],
      header: e(
      ...
      buttons: e(
        '<div data-dte-e="form_buttons" class="' + d.form.buttons + '"></div>'
      )[0],
    };
    if (e.fn.dataTable.TableTools) {
      var f = e.fn.dataTable.TableTools.BUTTONS,
        g = this.i18n;
      e.each(["create", "edit", "remove"], function (h, n) {
        f["editor_" + n].sButtonText = g[n].button;
      });
    }
    e.each(a.events, function (h, n) {
      b.on(h, function () {
    ...
    e(z)
      .on("init.dt.dte" + this.s.unique, function (h, n, p) {
        b.s.table && n.nTable === e(b.s.table).get(0) && (n._editor = b);
      })
      .on("xhr.dt.dte" + this.s.unique, function (h, n, p) {
        p &&
          b.s.table &&
          n.nTable === e(b.s.table).get(0) &&
          b._optionsUpdate(p);
      });
    try {
  ...
  m.prototype._ajax = function (a, b, d, f) {
    ...
    f = {
      ...
      complete: [
        function (q, k) {
          var l = null;
          if (204 === q.status || "null" === q.responseText) l = {};
          else
            try {
              l = q.responseJSON ? q.responseJSON : e.parseJSON(q.responseText);
            } catch (t) {}
          e.isPlainObject(l) || Array.isArray(l)
            ? b(l, 400 <= q.status, q)
            : d(q, k, c);
        },
      ],
    };
    var h = this.s.ajax || this.s.ajaxUrl,
      n = "edit" === g || "remove" === g ? M(this.s.editFields, "idSrc") : null;
    Array.isArray(n) && (n = n.join(","));
    e.isPlainObject(h) && h[g] && (h = h[g]);
    if ("function" === typeof h) {
      ...
      if (this.s.ajaxUrl) {
        ...
        r.create && (p = r[g]);
        -1 !== p.indexOf(" ") && ((g = p.split(" ")), (f = g[0]), (p = g[1]));
        p = p.replace(/_id_/, n);
      }
      h(f, p, a, b, d);
    } else
      "string" === typeof h
        ? -1 !== h.indexOf(" ")
          ? ((g = h.split(" ")), (f.type = g[0]), (f.url = g[1]))
          : (f.url = h)
        : ((h = e.extend({}, h || {})),
          h.complete && (f.complete.unshift(h.complete), delete h.complete),
          h.error && (f.error.unshift(h.error), delete h.error),
          (f = e.extend({}, f, h))),
        (f.url = f.url.replace(/_id_/, n)),
        f.data &&
          ((h = (n = "function" === typeof f.data) ? f.data(a) : f.data),
          (a = n && h ? h : e.extend(!0, a, h))),
        (f.data = a),
        "DELETE" !== f.type ||
          (f.deleteBody !== u && !0 !== f.deleteBody) ||
          ((a = e.param(f.data)),
          (f.url += -1 === f.url.indexOf("?") ? "?" + a : "&" + a),
          delete f.data),
        e.ajax(f);
  };
  m.prototype._animate = function (a, b, d, f) {
    e.fn.animate
      ? a.stop().animate(b, d, f)
      : (a.css(b), "function" === typeof d ? d.call(a) : f && f.call(a));
  };
  ...
  m.prototype._displayReorder = function (a) {
    ...
    d.children().detach();
    e.each(g, function (n, p) {
      n = p instanceof m.Field ? p.name() : p;
      -1 !== b._weakInArray(n, a) &&
        (c && "main" === h
          ? (c.find('editor-field[name="' + n + '"]').after(f[n].node()),
            c.find('[data-editor-template="' + n + '"]').append(f[n].node()))
          : d.append(f[n].node()));
    });
    c && "main" === h && c.appendTo(d);
    this._event("displayOrder", [this.s.displayed, this.s.action, d]);
  };
  m.prototype._edit = function (a, b, d, f, g) {
    var c = this,
      h = this.s.fields,
      n = [],
      p,
    ...
    e.each(h, function (k, l) {
      ...
      e.each(b, function (t, v) {
        if (v.fields[k]) {
          ...
          if (!f || "row" === f.scope) {
            if (
              (l.multiSet(t, w !== u ? w : l.def()),
              !v.displayFields || v.displayFields[k])
            )
              p = !0;
          } else if (!v.displayFields || v.displayFields[k])
            l.multiSet(t, w !== u ? w : l.def()), (p = !0);
        }
      });
      0 !== l.multiIds().length && p && n.push(k);
    });
    h = this.order().slice();
    for (var q = h.length - 1; 0 <= q; q--)
      -1 === e.inArray(h[q].toString(), n) && h.splice(q, 1);
    this._displayReorder(h);
    this._event(
      "initEdit",
      [M(b, "node")[0], M(b, "data")[0], a, d],
      function () {
  ...
  m.prototype._event = function (a, b, d) {
    ...
    if (Array.isArray(a)) {
      d = 0;
      for (var f = a.length; d < f; d++) this._event(a[d], b);
    } else
      return (
        (f = e.Event(a)),
        e(this).triggerHandler(f, b),
        0 === a.indexOf("pre") &&
          !1 === f.result &&
          e(this).triggerHandler(e.Event(a + "Cancelled"), b),
        d &&
          (f.result && "object" === typeof f.result && f.result.then
            ? f.result.then(d)
            : d(f.result)),
        f.result
      );
  ...
  m.prototype._eventName = function (a) {
    for (var b = a.split(" "), d = 0, f = b.length; d < f; d++) {
      a = b[d];
      var g = a.match(/^on([A-Z])/);
      g && (a = g[1].toLowerCase() + a.substring(3));
      b[d] = a;
    }
    return b.join(" ");
  };
  ...
  m.prototype._focus = function (a, b) {
    var d = this,
      f;
    a = e.map(a, function (g) {
      return "string" === typeof g ? d.s.fields[g] : g;
    });
    "number" === typeof b
      ? (f = a[b])
      : b
  ...
  m.prototype._formOptions = function (a) {
    var b = this,
      ...
      f = ".dteInline" + d;
    a.closeOnComplete !== u &&
      (a.onComplete = a.closeOnComplete ? "close" : "none");
    a.submitOnBlur !== u && (a.onBlur = a.submitOnBlur ? "submit" : "close");
    a.submitOnReturn !== u &&
      (a.onReturn = a.submitOnReturn ? "submit" : "none");
    a.blurOnBackground !== u &&
      (a.onBackground = a.blurOnBackground ? "blur" : "none");
    this.s.editOpts = a;
    this.s.editCount = d;
    if ("string" === typeof a.title || "function" === typeof a.title)
      this.title(a.title), (a.title = !0);
    if ("string" === typeof a.message || "function" === typeof a.message)
      this.message(a.message), (a.message = !0);
    "boolean" !== typeof a.buttons &&
      (this.buttons(a.buttons), (a.buttons = !0));
    e(z).on("keydown" + f, function (g) {
      if (13 === g.keyCode && b.s.displayed) {
        var c = e(z.activeElement);
        if (c) {
          var h = b._fieldFromNode(c);
          h &&
            "function" === typeof h.canReturnSubmit &&
            h.canReturnSubmit(c) &&
            g.preventDefault();
        }
      }
    });
    e(z).on("keyup" + f, function (g) {
      var c = e(z.activeElement);
      if (13 === g.keyCode && b.s.displayed) {
        var h = b._fieldFromNode(c);
        h &&
          ...
          h.canReturnSubmit(c) &&
          ("submit" === a.onReturn
            ? (g.preventDefault(), b.submit())
            : "function" === typeof a.onReturn &&
              (g.preventDefault(), a.onReturn(b, g)));
      } else if (27 === g.keyCode)
        if ((g.preventDefault(), "function" === typeof a.onEsc)) a.onEsc(b, g);
        else
          "blur" === a.onEsc
            ? b.blur()
            : "close" === a.onEsc
            ? b.close()
            : "submit" === a.onEsc && b.submit();
      else
        c.parents(".DTE_Form_Buttons").length &&
          (37 === g.keyCode
            ? c.prev("button").focus()
            : 39 === g.keyCode && c.next("button").focus());
    });
  ...
  m.prototype._legacyAjax = function (a, b, d) {
    if (this.s.legacyAjax && d)
      if ("send" === a)
        if ("create" === b || "edit" === b) {
          var f;
          e.each(d.data, function (g, c) {
            if (f !== u)
          ...
          (d.id = e.map(d.data, function (g, c) {
            return c;
          })),
            delete d.data;
    ...
    a.options &&
      e.each(this.s.fields, function (d, f) {
        a.options[d] !== u &&
          (f = b.field(d)) &&
          f.update &&
          f.update(a.options[d]);
      });
  };
  m.prototype._message = function (a, b, d, f) {
    var g = e.fn.animate ? !0 : !1;
    d === u && (d = !1);
    f || (f = function () {});
  ...
  m.prototype._multiInfo = function () {
    ...
    if (b)
      for (var f = 0, g = b.length; f < g; f++) {
        var c = a[b[f]];
        var h = c.multiEditable();
        c.isMultiValue() && h && d
          ? ((c = !0), (d = !1))
          : (c = c.isMultiValue() && !h ? !0 : !1);
  ...
  m.prototype._postopen = function (a, b) {
    ...
    e(this.dom.form)
      ...
      .on("submit.editor-internal", function (g) {
        g.preventDefault();
      });
    if (f && ("main" === a || "bubble" === a))
      e("body").on("focus.editor-focus", function () {
        0 === e(z.activeElement).parents(".DTE").length &&
          0 === e(z.activeElement).parents(".DTED").length &&
          d.s.setFocus &&
          d.s.setFocus.focus();
      });
    this._multiInfo();
  ...
  m.prototype._preopen = function (a) {
    if (!1 === this._event("preOpen", [a, this.s.action]))
      return (
        ...
        this._event("cancelOpen", [a, this.s.action]),
        ("inline" !== this.s.mode && "bubble" !== this.s.mode) ||
          !this.s.closeIcb ||
          this.s.closeIcb(),
  ...
  m.prototype._submit = function (a, b, d, f) {
    var g = this,
      ...
      h = {},
      n = {},
      p = E.ext.oApi._fnSetObjectDataFn,
      r = this.s.fields,
      q = this.s.editCount,
      k = this.s.editFields,
      l = this.s.editData,
    ...
    if (!1 !== this._noProcessing(arguments)) {
      ...
      if ("create" === w || "edit" === w)
        if (
          (e.each(k, function (B, D) {
            var F = {},
              H = {};
            e.each(r, function (J, N) {
              if (D.fields[J] && N.submittable()) {
                var L = N.multiGet(),
                  Q = p(J);
                if (L[B] === u) (J = N.valFromData(D.data)), Q(F, J);
                else {
                  L = L[B];
                  var O =
                    Array.isArray(L) && -1 !== J.indexOf("[]")
                      ? p(J.replace(/\[.*$/, "") + "-many-count")
                      : null;
                  Q(F, L);
                  O && O(F, L.length);
                  "edit" !== w ||
                    (l[J] && N.compare(L, l[J][B])) ||
                    (Q(H, L), (c = !0), O && O(H, L.length));
                }
              }
            });
            e.isEmptyObject(F) || (h[B] = F);
            e.isEmptyObject(H) || (n[B] = H);
          }),
          "create" === w || "all" === v || ("allIfChanged" === v && c))
        )
          A.data = h;
        else if ("changed" === v && c) A.data = n;
        else {
          this.s.action = null;
          if ("close" === t.onComplete && (f === u || f)) this._close(!1);
          else if ("function" === typeof t.onComplete) t.onComplete(this);
          a && a.call(this);
          this._processing(!1);
      ...
      var x = e.extend(!0, {}, A);
      d && d(A);
      this._event("preSubmit", [A, w], function (B) {
        !1 === B
          ? g._processing(!1)
          : (g.s.ajax || g.s.ajaxUrl ? g._ajax : g._submitTable).call(
              g,
              A,
              function (D, F, H) {
                g._submitSuccess(D, F, A, x, g.s.action, q, f, a, b, H);
              },
              function (D, F, H) {
                g._submitError(D, F, H, b, A, g.s.action);
              },
              A
            );
      });
  ...
  m.prototype._submitTable = function (a, b, d, f) {
    var g = a.action,
      c = { data: [] },
      h = E.ext.oApi._fnGetObjectDataFn(this.s.idSrc),
      n = E.ext.oApi._fnSetObjectDataFn(this.s.idSrc);
    if ("remove" !== g) {
      var p =
        "main" === this.s.mode
      ...
      e.each(a.data, function (r, q) {
        ...
        q = h(l);
        "create" === g && q === u ? n(l, +new Date() + "" + r) : n(l, q);
        c.data.push(l);
      });
    }
    b(c);
  };
  m.prototype._submitSuccess = function (a, b, d, f, g, c, h, n, p, r) {
    var q = this,
      k = this.s.fields,
      l = this.s.editOpts,
      t = this.s.modifier;
    this._legacyAjax("receive", g, a);
    this._event("postSubmit", [a, d, g, r]);
    a.error || (a.error = "");
    ...
    if (b || a.error || a.fieldErrors.length) {
      ...
      e.each(a.fieldErrors, function (A, x) {
        ...
        if (B)
          if (B.displayed()) {
            if ((B.error(x.status || "Error"), 0 === A))
              if ("focus" === l.onFieldError)
                q._animate(
                  e(q.dom.bodyContent, q.s.wrapper),
                  { scrollTop: e(B.node()).position().top },
                  500
                ),
                  B.focus();
              else if ("function" === typeof l.onFieldError)
                l.onFieldError(q, x);
      ...
      if (!a.data || ("create" !== g && "edit" !== g))
        "remove" === g &&
          (this._dataSource("prep", g, t, f, a, b),
          this._event("preRemove", [a, this.ids()]),
          this._dataSource("remove", t, k, b),
          this._event(["remove", "postRemove"], [a, this.ids()]),
          this._dataSource("commit", g, t, a.data, b));
      else {
        this._dataSource("prep", g, t, f, a, b);
        for (f = 0; f < a.data.length; f++) {
          var w = a.data[f];
          d = this._dataSource("id", w);
          this._event("setData", [a, w, g]);
          "create" === g
            ? (this._event("preCreate", [a, w, d]),
              this._dataSource("create", k, w, b),
              this._event(["create", "postCreate"], [a, w, d]))
            : "edit" === g &&
              (this._event("preEdit", [a, w, d]),
              this._dataSource("edit", t, k, w, b),
              this._event(["edit", "postEdit"], [a, w, d]));
        }
        this._dataSource("commit", g, t, a.data, b);
      }
      if (c === this.s.editCount)
        if (
          ((g = this.s.action),
          (this.s.action = null),
          "close" === l.onComplete && (h === u || h))
        )
          this._close(a.data ? !0 : !1, g);
        else if ("function" === typeof l.onComplete) l.onComplete(this);
      n && n.call(q, a);
      this._event("submitSuccess", [a, w, g]);
    }
    this._processing(!1);
    this._event("submitComplete", [a, w, g]);
  };
  m.prototype._submitError = function (a, b, d, f, g, c) {
    this._event("postSubmit", [null, g, c, a]);
    this.error(this.i18n.error.system);
    this._processing(!1);
    f && f.call(this, a, b, d);
    this._event(["submitError", "submitComplete"], [a, b, d, g]);
  };
  m.prototype._tidy = function (a) {
    ...
    return this.s.processing
      ? (this.one("submitComplete", function () {
        ...
        !0)
      : "inline" === this.display() || "bubble" === this.display()
      ? (this.one("close", function () {
          if (b.s.processing)
            b.one("submitComplete", function (g, c) {
              if (f && c) d.one("draw", a);
              else
                setTimeout(function () {
                  b.s && a();
  ...
  m.prototype._weakInArray = function (a, b) {
    for (var d = 0, f = b.length; d < f; d++) if (a == b[d]) return d;
    return -1;
  };
  m.defaults = {
    table: null,
    ...
    i18n: {
      close: "Close",
      create: { button: "New", title: "등록", submit: "Create" },
      edit: { button: "Edit", title: "수정", submit: "Update" },
      remove: {
        button: "Delete",
        title: "Delete",
        submit: "Delete",
  ...
  (function () {
    function a(k) {
      ...
      if (
        "keyless" !== k &&
        ((l = e('[data-editor-id="' + k + '"]')),
        0 === l.length && (l = "string" === typeof k ? e(q(k)) : e(k)),
        0 === l.length)
      )
        throw (
          "Could not find an element with `data-editor-id` or `id` of: " + k
        );
      return l;
    }
    function b(k, l) {
    ...
    function d(k, l, t) {
      e.each(l, function (v, w) {
        ...
        v !== u &&
          ((w = b(k, w.dataSrc())),
          w.filter("[data-editor-value]").length
            ? w.attr("data-editor-value", v)
            : w
                .each(function () {
    ...
    var f = (m.dataSources = {}),
      g = function (k, l) {
        return (
          k.settings()[0].oFeatures.bServerSide &&
          "none" !== l.s.editOpts.drawType
        );
      },
      c = function (k) {
        k = e(k);
        ...
        l.cells(t)
          ...
          .each(function (x) {
            var B = l.cell(x),
              D = l.row(x.row).data();
            D = w(D);
            var F = A || n(l, v, x.column),
              H = ("object" === typeof t && t.nodeName) || t instanceof e;
            if (k[D]) {
              var J = k[D].attach;
            ...
            k[D].attach = J || [];
            k[D].attach.push(
              H ? e(t).get(0) : B.fixedNode ? B.fixedNode() : B.node()
            );
            k[D].displayFields = N || {};
            e.extend(k[D].displayFields, F);
          });
      },
      r = function (k, l, t, v, w) {
        l.cells(null, t)
          .indexes()
          .each(function (A) {
            p(k, l, A, v, w);
    ...
    f.dataTable = {
      ...
      fields: function (k) {
        var l = E.ext.oApi._fnGetObjectDataFn(this.s.idSrc),
          ...
          w = {};
        !e.isPlainObject(k) ||
        (k.rows === u && k.columns === u && k.cells === u)
          ? h(w, t, k, v, l)
          : (k.rows !== u && h(w, t, k.rows, v, l),
            k.columns !== u && r(w, t, k.columns, v, l),
            k.cells !== u && p(w, t, k.cells, v, l));
        return w;
      },
      create: function (k, l) {
        k = e(this.s.table).DataTable();
        g(k, this) || ((l = k.row.add(l)), c(l.node()));
      },
      edit: function (k, l, t, v) {
        var w = this;
        k = e(this.s.table).DataTable();
        if (!g(k, this) || "none" === this.s.editOpts.drawType) {
          ...
          x.any() ||
            (x = k.row(function (B, D, F) {
              return A == f.dataTable.id.call(w, D);
            }));
          x.any()
            ? ((k = e.fn.dataTableExt.oApi._fnExtend),
              (l = k({}, x.data(), !0)),
              (l = k(l, t, !0)),
              x.data(l),
              (t = e.inArray(A, v.rowIds)),
              v.rowIds.splice(t, 1))
            : (x = k.row.add(t));
          c(x.node());
        }
      },
      remove: function (k, l, t) {
        var v = this;
        l = e(this.s.table).DataTable();
        var w = t.cancelled;
        if (0 === w.length) l.rows(k).remove();
        else {
          var A = [];
      ...
      commit: function (k, l, t, v) {
        var w = this;
        l = e(this.s.table).DataTable();
        if (!g(l, this) && "edit" === k && v.rowIds.length) {
          k = v.rowIds;
          v = function (B) {
        ...
        "none" !== x &&
          (l.draw(x),
          l.responsive && l.responsive.recalc(),
          "function" !== typeof l.searchPanes ||
            l.settings()[0].oFeatures.bServerSide ||
            l.searchPanes.rebuildPane(u, !0));
      },
    };
    f.html = {
      id: function (k) {
      ...
      individual: function (k, l) {
        ...
        e.each(v, function (x, B) {
          ...
          if (t) x = e(t);
            ...
            x = k;
            for (var D = l, F = e(), H = 0, J = D.length; H < J; H++)
              F = F.add(b(x, D[H]));
            x = F.toArray();
          }
          B.attach = x;
      ...
      fields: function (k) {
        ...
        e.each(t, function (B, D) {
          B = D.dataSrc();
          B = b(k, B);
          B = B.filter("[data-editor-value]").length
            ? B.attr("data-editor-value")
            : B.html();
          D.valToData(x, null === B ? u : B);
        });
        l[k] = { idSrc: k, data: x, node: z, fields: t, type: "row" };
        return l;
      },
      create: function (k, l) {
        if (l) {
  ...
  m.classes = {
    wrapper: "DTE",
    processing: { indicator: "DTE_Processing_Indicator", active: "processing" },
  ...
  (function () {
    if (E.TableTools) {
      var a = E.TableTools.BUTTONS,
        b = { sButtonText: null, editor: null, formTitle: null };
      a.editor_create = e.extend(!0, a.text, b, {
        ...
        fnClick: function (d, f) {
          d = f.editor;
          var g = d.i18n.create;
          f = f.formButtons;
          f[0].label || (f[0].label = g.submit);
          d.create({ title: g.title, buttons: f });
        },
      });
      a.editor_edit = e.extend(!0, a.select_single, b, {
        ...
        fnClick: function (d, f) {
          ...
          if (1 === d.length) {
            ...
            g.edit(d[0], { title: c.title, buttons: f });
          }
        },
      });
      a.editor_remove = e.extend(!0, a.select, b, {
        ...
        formButtons: [
          {
            ...
            fn: function (d) {
              ...
              this.submit(function (g) {
                e.fn.dataTable.TableTools.fnGetInstance(
                  e(f.s.table).DataTable().table().node()
                ).fnSelectNone();
              });
            },
          },
        ...
        fnClick: function (d, f) {
          ...
          if (0 !== d.length) {
            ...
            f[0].label || (f[0].label = c.submit);
            g.remove(d, {
              message: h.replace(/%d/g, d.length),
              title: c.title,
              buttons: f,
            });
          }
    ...
    e.extend(a, {
      create: {
        text: function (d, f, g) {
          return d.i18n("buttons.create", g.editor.i18n.create.button);
        },
      ...
      edit: {
        extend: "selected",
        text: function (d, f, g) {
          return d.i18n("buttons.edit", g.editor.i18n.edit.button);
        },
        ...
        action: function (d, f, g, c) {
          var h = this;
          d = c.editor;
          g = f.rows({ selected: !0 }).indexes();
          var n = f.columns({ selected: !0 }).indexes();
          f = f.cells({ selected: !0 }).indexes();
          f = n.length || f.length ? { rows: g, columns: n, cells: f } : g;
          this.processing(!0);
          d.one("preOpen", function () {
            h.processing(!1);
          }).edit(f, {
      ...
      remove: {
        ...
        limitTo: ["rows"],
        text: function (d, f, g) {
          return d.i18n("buttons.remove", g.editor.i18n.remove.button);
        },
        ...
        formMessage: function (d, f) {
          f = f.rows({ selected: !0 }).indexes();
          d = d.i18n.remove;
          return (
            "string" === typeof d.confirm
              ? d.confirm
              : d.confirm[f.length]
              ? d.confirm[f.length]
              : d.confirm._
          ).replace(/%d/g, f.length);
        },
        formTitle: null,
        action: function (d, f, g, c) {
          var h = this;
          ...
          d.one("preOpen", function () {
            h.processing(!1);
          }).remove(f.rows({ selected: !0 }).indexes(), {
            buttons: c.formButtons,
  ...
  m.DateTime = function (a, b) {
    ...
    var d = this.c.i18n;
    if (!y.moment && "YYYY-MM-DD" !== this.c.format)
  ...
  e.extend(m.DateTime.prototype, {
    ...
    val: function (a, b) {
      ...
      if (a instanceof Date) this.s.d = this._dateToUtc(a);
        ...
        if (y.moment) {
          ...
          (d = a.match(/(\d{4})\-(\d{2})\-(\d{2})/)),
            (this.s.d = d ? new Date(Date.UTC(d[1], d[2] - 1, d[3])) : null);
      ...
      this.dom.container
        .on("change", "select", function () {
          var f = e(this),
            g = f.val();
          f.hasClass(b + "-month")
            ? (a._correctMonth(a.s.display, g), a._setTitle(), a._setCalander())
            : f.hasClass(b + "-year")
            ? (a.s.display.setUTCFullYear(g), a._setTitle(), a._setCalander())
            : f.hasClass(b + "-hours") || f.hasClass(b + "-ampm")
            ? (a.s.parts.hours12
                ? ((f =
                    1 *
                    e(a.dom.container)
                  ...
                  (g =
                    ...
                    e(a.dom.container)
                      ...
                      .val()),
                  a.s.d.setUTCHours(
                    12 !== f || g ? (g && 12 !== f ? f + 12 : f) : 0
                  ))
                : a.s.d.setUTCHours(g),
              a._setTime(),
              a._writeOutput(!0),
              d())
            : f.hasClass(b + "-minutes")
            ? (a.s.d.setUTCMinutes(g), a._setTime(), a._writeOutput(!0), d())
            : f.hasClass(b + "-seconds") &&
              (a.s.d.setSeconds(g), a._setTime(), a._writeOutput(!0), d());
          a.dom.input.focus();
          a._position();
        })
        .on("click", function (f) {
          var g = a.s.d,
            ...
            h = "span" === c ? f.target.parentNode : f.target;
          c = h.nodeName.toLowerCase();
          if ("select" !== c)
            if ((f.stopPropagation(), "button" === c))
              if (
                ((h = e(h)),
                (f = h.parent()),
                f.hasClass("disabled") && !f.hasClass("range"))
              )
                h.blur();
              else if (f.hasClass(b + "-iconLeft"))
                ...
                if (h.parents("." + b + "-time").length) {
                  ...
                  if ("am" === c)
                    if (12 <= g.getUTCHours()) c = g.getUTCHours() - 12;
                    else return;
                  else if ("pm" === c)
                    if (12 > g.getUTCHours()) c = g.getUTCHours() + 12;
                    else return;
                  ...
                  g || (g = a._dateToUtc(new Date())),
                    g.setUTCDate(1),
                    g.setUTCFullYear(h.data("year")),
                    g.setUTCMonth(h.data("month")),
                    g.setUTCDate(h.data("day")),
                    a._writeOutput(!0),
                    a.s.parts.time
                      ? a._setCalander()
                      : setTimeout(function () {
    ...
    _htmlMonth: function (a, b) {
      var d = this._dateToUtc(new Date()),
        ...
        g = new Date(Date.UTC(a, b, 1)).getUTCDay(),
        c = [],
        h = [];
      0 < this.c.firstDay && ((g -= this.c.firstDay), 0 > g && (g += 7));
      for (var n = f + g, p = n; 7 < p; ) p -= 7;
      n += 7 - p;
      var r = this.c.minDate;
      p = this.c.maxDate;
      r && (r.setUTCHours(0), r.setUTCMinutes(0), r.setSeconds(0));
      p && (p.setUTCHours(23), p.setUTCMinutes(59), p.setSeconds(59));
      for (var q = 0, k = 0; q < n; q++) {
        var l = new Date(Date.UTC(a, b, 1 + (q - g))),
          t = this.s.d ? this._compareDates(l, this.s.d) : !1,
          v = this._compareDates(l, d),
          w = q < g || q >= f + g,
          A = (r && l < r) || (p && l > p),
          x = this.c.disableDays;
        Array.isArray(x) && -1 !== e.inArray(l.getUTCDay(), x)
          ? (A = !0)
          : "function" === typeof x && !0 === x(l) && (A = !0);
        h.push(
          this._htmlDay({
            day: 1 + (q - g),
            month: b,
        ...
        7 === ++k &&
          (this.c.showWeekNumber &&
            h.unshift(this._htmlWeekOfYear(q - g, b, a)),
          c.push("<tr>" + h.join("") + "</tr>"),
          (h = []),
          (k = 0));
      }
      ...
      r &&
        ((r = r >= new Date(Date.UTC(a, b, 1, 0, 0, 0))),
        this.dom.title
          .find("div." + d + "-iconLeft")
          .css("display", r ? "none" : "block"));
      p &&
        ((a = p < new Date(Date.UTC(a, b + 1, 1, 0, 0, 0))),
        this.dom.title
    ...
    _htmlMonthHead: function () {
      ...
      for (var g = 0; 7 > g; g++) a.push("<th>" + f(g) + "</th>");
      return a.join("");
    },
    _htmlWeekOfYear: function (a, b, d) {
      ...
      return (
        ...
        this.c.classPrefix +
        '-week">' +
        Math.ceil(((a - new Date(d, 0, 1)) / 864e5 + 1) / 7) +
        "</td>"
      );
    },
    _options: function (a, b, d) {
      d || (d = b);
    ...
    _optionsTime: function (a, b, d, f, g) {
      var c = this.c.classPrefix,
        h = this.dom.container.find("div." + c + "-" + a),
        n =
          12 === b
            ? function (v) {
                return v;
      ...
      if (h.length) {
        var q = "";
        var k = 10;
        var l = function (v, w, A) {
          12 === b &&
            "number" === typeof v &&
            (12 <= d && (v += 12), 12 == v ? (v = 0) : 24 == v && (v = 12));
          var x =
            d === v || ("am" === v && 12 > d) || ("pm" === v && 12 <= d)
              ? "selected"
              : "";
        ...
        if (12 === b) {
          q += "<tr>";
          for (g = 1; 6 >= g; g++) q += l(g, n(g));
          q += l("am", r.amPm[0]);
          q += "</tr><tr>";
          for (g = 7; 12 >= g; g++) q += l(g, n(g));
          q += l("pm", r.amPm[1]);
          q += "</tr>";
          k = 7;
        } else {
          if (24 === b) {
            ...
            for (k = 0; 4 > k; k++) {
              q += "<tr>";
              for (g = 0; 6 > g; g++) (q += l(t, n(t))), t++;
              q += "</tr>";
            }
          } else {
            q += "<tr>";
            for (k = 0; 60 > k; k += 10) q += l(k, n(k), "range");
            g = null !== g ? g : 10 * Math.floor(d / 10);
            q =
              q +
              '</tr></tbody></thead><table class="' +
              (p + " " + p + '-nospace"><tbody><tr>');
            for (k = g + 1; k < g + 10; k++) q += l(k, n(k));
            q += "</tr>";
          }
          k = 6;
        }
    ...
    _position: function () {
      ...
      this.s.parts.date && this.s.parts.time && 550 < e(y).width()
        ? b.addClass("horizontal")
        : b.removeClass("horizontal");
      b.css({ top: a.top + d, left: a.left }).appendTo("body");
      var f = b.outerHeight(),
        g = b.outerWidth(),
        c = e(y).scrollTop();
      a.top + d + f - c > e(y).height() &&
        ((d = a.top - f), b.css("top", 0 > d ? 0 : d));
      g + a.left > e(y).width() &&
        ((a = e(y).width() - g), b.css("left", 0 > a ? 0 : a));
    },
    _range: function (a, b, d) {
      var f = [];
      for (d || (d = 1); a <= b; a += d) f.push(a);
      return f;
    },
    ...
    _setTime: function () {
      var a = this,
        ...
        d = b ? b.getUTCHours() : 0,
        f = function (g) {
          return a.c[g + "Available"]
            ? a.c[g + "Available"]
            : a._range(0, 59, a.c[g + "Increment"]);
        };
      this._optionsTime(
        "hours",
    ...
    _show: function () {
      ...
      setTimeout(function () {
        e("body").on("click." + b, function (d) {
          e(d.target).parents().filter(a.dom.container).length ||
            d.target === a.dom.input[0] ||
            a._hide();
        });
      }, 10);
    },
    _writeOutput: function (a) {
      var b = this.s.d,
        d = y.moment
          ? y.moment
              .utc(b, u, this.c.momentLocale, this.c.momentStrict)
      ...
      this.dom.input.val(d).trigger("change", { write: b });
  ...
  (function () {
    function a(c, h) {
      if (null === h || h === u) h = c.uploadText || "Choose file...";
      c._input.find("div.upload button").html(h);
    }
    function b(c, h, n, p) {
      var r = c.classes.form.buttonInternal,
        q = e(
          '<div class="editor_upload"><div class="eu_table"><div class="row"><div class="cell upload limitHide"><button class="' +
            r +
            '"></button><input type="file" ' +
            (p ? "multiple" : "") +
            '></input></div><div class="cell clearValue"><button class="' +
            r +
            '"></button></div></div><div class="row second"><div class="cell limitHide"><div class="drop"><span></span></div></div><div class="cell"><div class="rendered"></div></div></div></div></div>'
        );
      h._input = q;
      h._enabled = !0;
      h.id && q.find("input[type=file]").attr("id", m.safeId(h.id));
      h.attr && q.find("input[type=file]").attr(h.attr);
      a(h);
      if (y.FileReader && !1 !== h.dragDrop) {
        q.find("div.drop span").text(
          h.dragDropText || "Drag and drop a file here to upload"
        );
        var k = q.find("div.drop");
        k.on("drop", function (l) {
          h._enabled &&
            (m.upload(c, h, l.originalEvent.dataTransfer.files, a, n),
            k.removeClass("over"));
          return !1;
        })
          .on("dragleave dragexit", function (l) {
            h._enabled && k.removeClass("over");
            return !1;
          })
          .on("dragover", function (l) {
            h._enabled && k.addClass("over");
            return !1;
          });
        c.on("open", function () {
      ...
      q.find("div.clearValue button").on("click", function (l) {
        l.preventDefault();
        h._enabled && m.fieldTypes.upload.set.call(c, h, "");
      });
      q.find("input[type=file]").on("input", function () {
        m.upload(c, h, this.files, a, function (l) {
          n.call(c, l);
    ...
    function d(c) {
      setTimeout(function () {
        c.trigger("change", { editor: !0, editorSet: !0 });
      }, 0);
    }
    var f = m.fieldTypes,
      g = e.extend(!0, {}, m.models.fieldType, {
        get: function (c) {
          return c._input.val();
        },
        set: function (c, h) {
    ...
    f.readonly = e.extend(!0, {}, g, {
      create: function (c) {
        c._input = e("<input/>").attr(
          e.extend(
            { id: m.safeId(c.id), type: "text", readonly: "readonly" },
            c.attr || {}
          )
        );
        return c._input[0];
    ...
    f.text = e.extend(!0, {}, g, {
      create: function (c) {
        c._input = e("<input/>").attr(
          e.extend({ id: m.safeId(c.id), type: "text" }, c.attr || {})
        );
        return c._input[0];
      },
    });
    f.password = e.extend(!0, {}, g, {
      create: function (c) {
        c._input = e("<input/>").attr(
          e.extend({ id: m.safeId(c.id), type: "password" }, c.attr || {})
        );
        return c._input[0];
      },
    });
    f.textarea = e.extend(!0, {}, g, {
      create: function (c) {
        c._input = e("<textarea></textarea>").attr(
          e.extend({ id: m.safeId(c.id) }, c.attr || {})
        );
        return c._input[0];
      },
      canReturnSubmit: function (c, h) {
    ...
    f.select = e.extend(!0, {}, g, {
      _addOptions: function (c, h, n) {
        var p = c._input[0].options,
          r = 0;
        if (n) r = p.length;
        else if (((p.length = 0), c.placeholder !== u)) {
          n = c.placeholderValue !== u ? c.placeholderValue : "";
          r += 1;
          p[0] = new Option(c.placeholder, n);
        ...
        h &&
          m.pairs(h, c.optionsPair, function (k, l, t, v) {
            l = new Option(l, k);
            l._editor_val = k;
            v && e(l).attr(v);
            p[t + r] = l;
      ...
      create: function (c) {
        c._input = e("<select></select>")
          .attr(
            e.extend(
              { id: m.safeId(c.id), multiple: !0 === c.multiple },
              c.attr || {}
            )
          )
          .on("change.dte", function (h, n) {
            (n && n.editor) || (c._lastSet = f.select.get(c));
          });
        f.select._addOptions(c, c.options || c.ipOpts);
        return c._input[0];
      },
      update: function (c, h, n) {
        f.select._addOptions(c, h, n);
        h = c._lastSet;
        h !== u && f.select.set(c, h, !0);
        d(c._input);
      },
      get: function (c) {
        var h = c._input
      ...
      set: function (c, h, n) {
        n || (c._lastSet = h);
        c.multiple && c.separator && !Array.isArray(h)
          ? (h = "string" === typeof h ? h.split(c.separator) : [])
          : Array.isArray(h) || (h = [h]);
        var p,
          r = h.length,
          q,
    ...
    f.checkbox = e.extend(!0, {}, g, {
      _addOptions: function (c, h, n) {
        var p = c._input,
          r = 0;
        n ? (r = e("input", p).length) : p.empty();
        h &&
          m.pairs(h, c.optionsPair, function (q, k, l, t) {
            p.append(
              '<div><input id="' +
                m.safeId(c.id) +
                "_" +
            ...
            e("input:last", p).attr("value", q)[0]._editor_val = q;
            t && e("input:last", p).attr(t);
          });
      },
      create: function (c) {
        c._input = e("<div></div>");
      ...
      get: function (c) {
        var h = [],
          n = c._input.find("input:checked");
        n.length
          ? n.each(function () {
              h.push(this._editor_val);
            })
          : c.unselectedValue !== u && h.push(c.unselectedValue);
        return c.separator === u || null === c.separator
          ? h
          : h.join(c.separator);
      },
      set: function (c, h) {
        var n = c._input.find("input");
        Array.isArray(h) || "string" !== typeof h
          ? Array.isArray(h) || (h = [h])
          : (h = h.split(c.separator || "|"));
        var p,
          r = h.length,
          q;
        n.each(function () {
    ...
    f.radio = e.extend(!0, {}, g, {
      ...
      set: function (c, h) {
        c._input.find("input").each(function () {
          this._preChecked = !1;
          this._preChecked =
            this._editor_val == h ? (this.checked = !0) : (this.checked = !1);
        });
      ...
      update: function (c, h, n) {
        var p = f.radio,
          r = p.get(c);
        p._addOptions(c, h, n);
        h = c._input.find("input");
        p.set(
          c,
          h.filter('[value="' + r + '"]').length ? r : h.eq(0).attr("value")
        );
      },
    });
    f.date = e.extend(!0, {}, g, {
      create: function (c) {
        ...
        e.datepicker
          ? (c._input.addClass("jqueryui"),
            c.dateFormat || (c.dateFormat = e.datepicker.RFC_2822),
            setTimeout(function () {
              e(c._input).datepicker(
                e.extend(
                  {
          ...
          : c._input.attr("type", "date");
        return c._input[0];
      },
      set: function (c, h) {
        e.datepicker && c._input.hasClass("hasDatepicker")
          ? c._input.datepicker("setDate", h).change()
          : e(c._input).val(h);
      },
      enable: function (c) {
        e.datepicker
          ? c._input.datepicker("enable")
          : e(c._input).prop("disabled", !1);
      },
      disable: function (c) {
        e.datepicker
          ? c._input.datepicker("disable")
          : e(c._input).prop("disabled", !0);
      },
      owns: function (c, h) {
        return e(h).parents("div.ui-datepicker").length ||
          e(h).parents("div.ui-datepicker-header").length
          ? !0
          : !1;
      },
    });
    f.datetime = e.extend(!0, {}, g, {
      create: function (c) {
        c._input = e("<input />").attr(
          e.extend(!0, { id: m.safeId(c.id), type: "text" }, c.attr)
        );
        c._picker = new m.DateTime(
          c._input,
          e.extend(
            { format: c.displayFormat || c.format, i18n: this.i18n.datetime },
            c.opts
          )
        );
        c._closeFn = function () {
        ...
        if (!1 === c.keyInput)
          c._input.on("keydown", function (h) {
            h.preventDefault();
          });
      ...
      get: function (c) {
        var h = c._input.val(),
          n = c._picker.c;
        return h && c.wireFormat && moment
          ? moment(h, n.format, n.momentLocale, n.momentStrict).format(
              c.wireFormat
            )
          : h;
      },
      set: function (c, h) {
        var n = c._picker.c;
        c._picker.val(
          h && c.wireFormat && moment
            ? moment(h, c.wireFormat, n.momentLocale, n.momentStrict).format(
                n.format
              )
            : h
        );
      ...
      owns: function (c, h) {
        return c._picker.owns(h);
      },
      errorMessage: function (c, h) {
        c._picker.errorMsg(h);
      },
      destroy: function (c) {
      ...
      minDate: function (c, h) {
        c._picker.min(h);
      },
      maxDate: function (c, h) {
        c._picker.max(h);
      },
    });
    f.upload = e.extend(!0, {}, g, {
      create: function (c) {
        var h = this;
        return b(h, c, function (n) {
          m.fieldTypes.upload.set.call(h, c, n[0]);
          h._event("postUpload", [c.name, n[0]]);
        });
      },
      get: function (c) {
        return c._val;
      ...
      set: function (c, h) {
        ...
        var n = c._input;
        if (c.display) {
          var p = n.find("div.rendered");
          c._val
            ? p.html(c.display(c._val))
            : p
                .empty()
                .append("<span>" + (c.noFileText || "No file") + "</span>");
        }
        p = n.find("div.clearValue button");
        h && c.clearText
          ? (p.html(c.clearText), n.removeClass("noClear"))
          : n.addClass("noClear");
    ...
    f.uploadMany = e.extend(!0, {}, g, {
      _showHide: function (c) {
        c.limit &&
          (c._container
            .find("div.limitHide")
            .css("display", c._val.length >= c.limit ? "none" : "block"),
          (c._limitLeft = c.limit - c._val.length));
      },
      create: function (c) {
        var h = this,
          n = b(
            ...
            c,
            function (p) {
              c._val = c._val.concat(p);
              m.fieldTypes.uploadMany.set.call(h, c, c._val);
              h._event("postUpload", [c.name, c._val]);
            },
            !0
          );
        n.addClass("multi").on("click", "button.remove", function (p) {
          p.stopPropagation();
          c._enabled &&
            ((p = e(this).data("idx")),
            c._val.splice(p, 1),
      ...
      set: function (c, h) {
        ...
        var n = this,
          p = c._input;
        if (c.display)
          if (((p = p.find("div.rendered").empty()), h.length)) {
            var r = e("<ul></ul>").appendTo(p);
            e.each(h, function (q, k) {
              r.append(
                "<li>" +
                  c.display(k, q) +
                  ' <button class="' +
                  n.classes.form.button +
                  ' remove" data-idx="' +
                  q +
                  '">&times;</button></li>'
              );
            });
          } else p.append("<span>" + (c.noFileText || "No files") + "</span>");
